...
/** WS DemandDispatcher that extends DemandDispatcher and implements the functions of 
 * IWSDemandDispatcher
 * 
 * @author 
 * @version WSDemandDispatcher
 */
public class WSDemandDispatcher extends DemandDispatcher implements IWSDemandDispatcher
{
   ...
   */
	public WSDemandDispatcher() 

	throws DemandDispatcherException, ClassNotFoundException, IOException
	{
		this.oTA = (ITransportAgent) new WSTransportAgent();
	...
	* @param pstr2
	*/
	public WSDemandDispatcher(String pstrOne, String pstrTwo)
    throws DemandDispatcherException, ClassNotFoundException, IOException
    {
	    	this.oTA = (ITransportAgent) new WSTransportAgent();
	    	log.debug("Instantiating Transport Agent for oTA ");
	...
	* @param poTA
	*/
	public WSDemandDispatcher(ITransportAgent poTA)
	{
	    	this.oTA = poTA;
	    	log.debug("Instantiating Transport Agent for oTA ");
	}
    ...
    throws DemandDispatcherException
    {
			while(true)
			{
				...
				{  
				   ...
				   //send.sendPacket("DMS Exception occured in read Demand function of WSDemand Dispatcher class");
	...
	*/
	...
	throws DemandDispatcherException
	{
			while(true)
			{
				...
				{
					log.debug("Problem in reading demand");
					//send.sendPacket("DMS Exception occured in readDemandIfExists function of WSDemand Dispatcher class");
	...
	throws DemandDispatcherException
		{
			while(true)
			{
				...
				{ 
					...
					// send.sendPacket("DMS Exception occured in readResult function of WSDemand Dispatcher class");
				    if(this.oTAExceptionHandler != null)
					{
						try 
						{
		 ...
		 while(true)
			{
				...
				{  
					log.debug("Problem in reading result");
					// send.sendPacket("DMS Exception occured in readResultExists Demand function of WSDemand Dispatcher class");
					if(this.oTAExceptionHandler != null)
					{
						try 
						{
	...
	*/
	...
	throws DemandDispatcherException
	{
			...
			while(oSignature != null)
			{
				...
				{  
					log.debug("Problem in reading result");
					// send.sendPacket("DMS Exception occured in writeDemand function of WSDemand Dispatcher class");
					if(this.oTAExceptionHandler != null)
					{
						try 
						{
	...
	*/
	...
	throws DemandDispatcherException
	{
			while(true)
			{
				...
				{   //send.sendPacket("DMS Exception occured in writeResult function of WSDemand Dispatcher class");
	...
	*/
	...
	throws DemandDispatcherException 
	{
			...
			while(oSignature != null)
			{
				...
				{
					log.debug("Problem in reading result");
					// send.sendPacket("DMS Exception occured in getvalue function of WSDemand Dispatcher class");
					if(this.oTAExceptionHandler != null)
					{
						try 
						{
